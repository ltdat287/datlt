...
<tr>
	...
	<td>
	   <input type="text" name="email_confirmation" value="{{ !empty(MemberHelper::getOld('email')) ? MemberHelper::getOld('email') : MemberHelper::getOld('email_confirmation') }}" class="pure-input-1">
...
<tr>
	...
	<td>
		<input type="text" name="birthday" value="{{ (MemberHelper::getOld('birthday')) ? (date('Y-m-d', strtotime(MemberHelper::getOld('birthday')))) : '' }}" class="pure-input-1">
